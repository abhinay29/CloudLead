  ...
  return (
    <>
      ...
      <p>
        ...
        of Cloudlead's Website, located at https://cloudlead.in.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Cloudlead if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing Cloudlead, you agreed to use
        cookies in agreement with the Cloudlead's Privacy Policy.{" "}
      </p>
      ...
      <p>
        ...
        Cloudlead for your own personal use subjected to restrictions set in
      ...
      <p>
        ...
        Cloudlead does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Cloudlead,its agents and/or affiliates. Comments reflect the
        views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, Cloudlead shall not be liable
      ...
      <p>
        Cloudlead reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Cloudlead a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Cloudlead; and (d) the link is
      ...
      <p>
        ...
        e-mail to Cloudlead. Please include your name, your organization name,
      ...
      <p>
        No use of Cloudlead's logo or other artwork will be allowed for linking
