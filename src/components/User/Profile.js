                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6">
                      <div className="mb-3">
                        ...
                        <input type="text" className="form-control" name="company" onChange={handleInput} value={profile.company} />
                      </div>
                    </div>
                  </div>
                  <div className="row">
                    ...
                    <div className="col-md-9">
                      <div className="mb-3">
                        ...
                        <input type="text" className="form-control" name="phone" onChange={handleInput} value={profile.phone} required />
                      </div>
                    </div>
                  </div>
                  <div className="mb-3">
