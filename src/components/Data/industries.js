...
export const manufacturingOptions = [
  ...
  { label: 'Mechanical & Industrial Engineering', value: 'Mechanical & Industrial Engineering' },
...
export const otherOptions = [
  ...
  { label: 'Individual & value Services', value: 'Individual & value Services' },
  ...
  { label: 'Public Relation & Communication', value: 'Public Relation & Communication' },
...
export const serviceOptions = [
  { label: 'Business and Supplies Equipments', value: 'Business and Supplies Equipments' },
  ...
  { label: 'Recerational Facilities & Services', value: 'Recerational Facilities & Services' },
]
...
export const ngoOptions = [
  { label: 'Non Profit Organisation Management', value: 'Non Profit Organisation Management' },
]
