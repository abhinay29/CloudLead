    ...
    if (localStorage.getItem("savedSearches")) {
      ...
      savedSearches.map(svd => {
        if (svd._id === e.value) {
          ...
          let position = []
          if (svd.query['position'] !== "") {
            if (svd.query['position'] instanceof Array) {
              svd.query['position'].map(v => {
                position.push({ value: v, label: v })
                return true;
              })
            } else {
              position = [{ value: svd.query['position'], label: svd.query['position'] }]
            }
          }

          let person_country = []
          if (svd.query['person_country'] !== "") {
            if (svd.query['person_country'] instanceof Array) {
              svd.query['person_country'].map(v => {
                person_country.push({ value: v, label: v })
                return true;
              })
            } else {
              person_country = [{ value: svd.query['person_country'], label: svd.query['person_country'] }]
            }
          }

          let person_state = []
          if (svd.query['person_state'] !== "") {
            if (svd.query['person_state'] instanceof Array) {
              svd.query['person_state'].map(v => {
                person_state.push({ value: v, label: v })
                return true;
              })
            } else {
              person_state = [{ value: svd.query['person_state'], label: svd.query['person_state'] }]
            }
          }

          let person_city = []
          if (svd.query['person_city'] !== "") {
            if (svd.query['person_city'] instanceof Array) {
              svd.query['person_city'].map(v => {
                person_city.push({ value: v, label: v })
                return true;
              })
            } else {
              person_city = [{ value: svd.query['person_city'], label: svd.query['person_city'] }]
            }
          }
          ...
          if (svd.query['role_finance'] !== "") {
            if (svd.query['role_finance'] instanceof Array) {
              ...
              role_finance = [{ value: svd.query['role_finance'], label: svd.query['role_finance'] }]
            }
          }
          ...
          if (svd.query['role_hr'] !== "") {
            if (svd.query['role_hr'] instanceof Array) {
              ...
              role_hr = [{ value: svd.query['role_hr'], label: svd.query['role_hr'] }]
            }
          }
          ...
          if (svd.query['role_marketing'] !== "") {
            if (svd.query['role_marketing'] instanceof Array) {
              ...
              role_marketing = [{ value: svd.query['role_marketing'], label: svd.query['role_marketing'] }]
            }
          }
          ...
          if (svd.query['role_purchase'] !== "") {
            if (svd.query['role_purchase'] instanceof Array) {
              ...
              role_purchase = [{ value: svd.query['role_purchase'], label: svd.query['role_purchase'] }]
            }
          }
          ...
          if (svd.query['role_operation'] !== "") {
            if (svd.query['role_operation'] instanceof Array) {
              ...
              role_operation = [{ value: svd.query['role_operation'], label: svd.query['role_operation'] }]
            }
          }
          ...
          if (svd.query['role_corporate'] !== "") {
            if (svd.query['role_corporate'] instanceof Array) {
              ...
              role_corporate = [{ value: svd.query['role_corporate'], label: svd.query['role_corporate'] }]
            }
          }
          ...
          if (svd.query['role_it'] !== "") {
            if (svd.query['role_it'] instanceof Array) {
              ...
              role_it = [{ value: svd.query['role_it'], label: svd.query['role_it'] }]
            }
          }
          ...
          if (svd.query['role_others'] !== "") {
            if (svd.query['role_others'] instanceof Array) {
              ...
              role_others = [{ value: svd.query['role_others'], label: svd.query['role_others'] }]
            }
          }
          ...
          if (svd.query['company_size_range'] !== "") {
            if (svd.query['company_size_range'] instanceof Array) {
              ...
              company_size_range = [{ value: svd.query['company_size_range'], label: svd.query['company_size_range'] }]
            }
          }
          ...
          if (svd.query['revenue_range'] !== "") {
            if (svd.query['revenue_range'] instanceof Array) {
              ...
              revenue_range = [{ value: svd.query['revenue_range'], label: svd.query['revenue_range'] }]
            }
          }
          ...
          if (svd.query['industry'] !== "") {
            if (svd.query['industry'] instanceof Array) {
              ...
              industry = [{ value: svd.query['industry'], label: svd.query['industry'] }]
            }
          }
          ...
          if (svd.query['keyword'] !== "") {
            if (svd.query['keyword'] instanceof Array) {
              ...
              keyword = [{ value: svd.query['keyword'], label: svd.query['keyword'] }]
            }
          }
