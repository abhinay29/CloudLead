            ...
            <div className="col-md-6">
              ...
              <form action="#" method="post" onSubmit={handleSubmit}>
                <div className="mb-3 first">
                  ...
                  <input type="email" className="form-control p-2 border-1 border-primary" value={email} onChange={handleChange} id="email" name="email" autoComplete="username" />
                </div>
                <input type="submit" value="Reset Password" disabled={disabled} className="btn py-3 btn-block w-100 btn-success" />
